...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cadastroForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.success) {
                showMessage(response.message || 'Conta criada com sucesso! Redirecionando para o login...', 'success');
    ...
    const ROUTES = Object.assign({ home: '/', login: '/login' }, window.UpBaloesRoutes || {});
