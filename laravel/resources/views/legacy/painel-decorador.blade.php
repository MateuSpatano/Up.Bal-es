...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/painel-decorador.css') }}">
</head>
<body class="bg-gray-50">
        ...
        <div class="border-t border-gray-200 p-4">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-800 truncate" id="user-name">--</p>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="user-dropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 opacity-0 invisible transition-all duration-200 transform translate-y-2 z-50">
                            <div class="py-2">
                                <a href="#account" id="manage-account-btn" class="dropdown-item flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200">
            ...
            <div id="account-module" class="module-content hidden">
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <div class="text-center py-12">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">Gerenciar Conta</h2>
                        <p class="text-gray-600 mb-6">Atualize suas informações pessoais e configurações da conta.</p>
                        <a href="{{ route('login') }}" class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 transform hover:scale-105 inline-block">
                            <i class="fas fa-edit mr-2"></i>Gerenciar Conta
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block w-full max-w-4xl p-0 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <form id="create-budget-form" class="p-6 space-y-6">
                    ...
                    <!-- Tamanho do Arco (condicional) -->
                    <div id="budget-arc-size-container" class="space-y-2 hidden">
    ...
    <div id="image-modal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <!-- Overlay -->
            <div class="fixed inset-0 transition-opacity bg-black bg-opacity-75" id="image-modal-overlay"></div>
            ...
            <div class="inline-block w-full max-w-4xl p-0 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div class="bg-gray-800 px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-xl font-semibold text-white">Imagem de Inspiração</h3>
                                <p class="text-gray-300 text-sm">Visualização ampliada</p>
                            </div>
                        </div>
                        <button id="close-image-modal" class="text-white hover:text-gray-200 transition-colors duration-200">
                            <i class="fas fa-times text-xl"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="p-6 text-center">
                    <img id="modal-image" src="" alt="Imagem de inspiração" class="max-w-full max-h-96 mx-auto rounded-lg shadow-lg">
                </div>
            </div>
        </div>
    </div>
