            ...
            <form id="cadastro-form" class="mt-4 sm:mt-6 space-y-3 sm:space-y-4 bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-3 sm:p-4 md:p-6 lg:p-8 border border-white/20">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="aceitar-termos" class="text-gray-700 cursor-pointer">
                            Eu aceito os <a href="<?php echo $baseUrl; ?>pages/termos-e-condicoes.html" class="text-blue-600 hover:text-blue-500 transition-colors duration-200 underline font-medium" onclick="event.stopPropagation();">termos e condições</a> e a <a href="<?php echo $baseUrl; ?>pages/politica-de-privacidade.html" class="text-blue-600 hover:text-blue-500 transition-colors duration-200 underline font-medium" onclick="event.stopPropagation();">política de privacidade</a>
                        </label>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <?php else: ?>
                        <a 
                            href="<?php echo $baseUrl; ?>pages/login.html"
                            class="group relative w-full flex justify-center py-2.5 px-4 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 transform hover:scale-105 shadow-md sm:py-3 sm:text-base"
                        >
                    <?php endif; ?>
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
